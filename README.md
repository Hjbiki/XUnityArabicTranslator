...
- هذا المشروع **للترجمة فقط** — مو حل لمشاكل عرض الحروف العربية بشكل عام
...
| المشكلة | الحل |
|---|---|
| الكلام ما يتغير بعد التحديث | احذف `_AutoGeneratedTranslations.txt` من مجلد Translation |
...
- This is a **translation-only** tool — not a general Arabic text rendering fix
